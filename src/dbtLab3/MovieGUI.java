...
public class MovieGUI {
	...
	public MovieGUI(Database db) {
		...
		SearchingPane userLoginPane = new SearchingPane(db);
		tabbedPane.addTab("Search", null, userLoginPane,
				"Search for pallet information");

		PalletCreationPane bookingPane = new PalletCreationPane(db);
		tabbedPane.addTab("Pallet Creation", null, bookingPane, "Create a Pallet");

		tabbedPane.setSelectedIndex(0);
		

		BlockingPane blockingPane = new BlockingPane(db);
		tabbedPane.addTab("Blocking Pane", null, blockingPane, "Block Pallet");
